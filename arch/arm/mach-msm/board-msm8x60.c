...
#if 0//def CONFIG_TOUCHSCREEN_QT602240
#define GPIO_PIN_TOUCH_SCL     65
#define GPIO_PIN_TOUCH_SDA     64

static struct i2c_gpio_platform_data gpio_i2c_21th_data = {
        .scl_pin = GPIO_PIN_TOUCH_SCL,
        .sda_pin = GPIO_PIN_TOUCH_SDA,
        .udelay = 2,    /* 250 KHz */
};

struct platform_device gpio_i2c_21th_device = {
        .name = "i2c-gpio",
        .id = 21,
        .dev = {
                .platform_data = &gpio_i2c_21th_data,
        }
};

static struct i2c_board_info gpio_i2c_21th_boardinfo[] __initdata = {
	{
...
#ifdef F_SKYCAM_ICP_HD
	{
#if AT1_BDVER_GE(AT1_WS20) //hhs 20110211 test
...
#if defined(BOARD_AT1_TEMP)  //hhs 20110127 test 
...
static struct rpm_vreg_pdata rpm_vreg_init_pdata[RPM_VREG_ID_MAX] = {
  ...
  //EF33S GPS VREG 2.0V
	RPM_VREG_INIT_LDO(PM8058_L9,  0, 1, 0, 2000000, 2000000, LDO300HMIN, 0),
	#ifdef CONFIG_SENSORS_MPU3050
...
//EF33/34 : Since WS20 Not use TDMB antenna switch, EF35L : Since TP10 Not use switch
...
#ifdef CONFIG_TOUCHSCREEN_QT602240
	RPM_VREG_INIT_LDO(PM8058_L11, 0, 1, 0, 1900000, 1900000, LDO150HMIN, 0), //AT1
#else
    ...
    #elif AT1_BDVER_GE(AT1_WS20)
	RPM_VREG_INIT_LDO(PM8058_L17, 0, 1, 0, 2800000, 2800000, LDO150HMIN, 0),
    #else
	RPM_VREG_INIT_LDO(PM8058_L17, 0, 1, 0, 2600000, 2600000, LDO150HMIN, 0),
	#endif
	...
	#if defined(BOARD_AT1_TEMP)
	RPM_VREG_INIT_LDO(PM8058_L24, 1, 1, 0, 1300000, 1300000, LDO150HMIN, 0),
	#else
...
#elif CONFIG_TOUCHSCREEN_QT602240
#if AT1_BDVER_LE(AT1_WS21) 
	RPM_VREG_INIT_VS(PM8058_LVS0, 0, 1, 1800000, 1800000),
#elif AT1_BDVER_G(AT1_WS22)  //hhs 20110405 lcd ldo modify
	RPM_VREG_INIT_VS(PM8058_LVS0, 0, 1, 1800000, 1800000),
#endif
#else
...
static struct platform_device *early_devices[] __initdata = {
	...
	&msm_bus_sys_fpb,
	&msm_bus_cpss_fpb,
	&msm_device_dmov_adm0,  // AT1 code aurora patch
	&msm_device_dmov_adm1,  // AT1 code aurora patch
#endif
};
...
{
    #if defined(BOARD_AT1_TEMP)  //hhs 20110422
	#else
...
static void display_common_power(int on)
{
	...
	#if AT1_BDVER_G(AT1_WS22)  //hhs 20110405 lcd ldo modify
...
#endif
#if 0//def CONFIG_TOUCHSCREEN_QT602240
	i2c_register_board_info(21, gpio_i2c_21th_boardinfo,ARRAY_SIZE(gpio_i2c_21th_boardinfo));
#endif
...
#if 0//def CONFIG_SKY_BATTERY_MAX17040
	max17040_init();
#endif	
