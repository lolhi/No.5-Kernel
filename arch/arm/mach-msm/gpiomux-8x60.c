...
// [ AT1 kyt : headset
static struct gpiomux_setting headset_remote_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
...
static struct gpiomux_setting headset_det_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_KEEPER,
	.dir = GPIOMUX_IN
...
#if AT1_BDVER_E(AT1_WS21) 	// headset AT1 kyt ws21
	{
		.gpio      = 123,
		.settings = {
			[GPIOMUX_SUSPENDED] = &headset_remote_suspend_cfg,
		},
	},
#else
	{
...
#endif
#if AT1_BDVER_GE(AT1_WS21) 	// headset kyt AT1 ws21
	{
		.gpio      = 125,
		.settings = {
			[GPIOMUX_SUSPENDED] = &headset_det_suspend_cfg,
		},
	},
#else
	{
