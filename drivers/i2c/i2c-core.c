...
//#define FEATURE_I2C_CORE_TEMP  //hhs 20101004 ci2 vee i2c

#if defined(FEATURE_I2C_CORE_TEMP)
...
static void vee_i2c_gpio_master_send(__u8 *addr_val)
{
  __u8 i=0;
...
int i2c_transfer(struct i2c_adapter *adap, struct i2c_msg *msgs, int num)
{
	...
	#if defined(FEATURE_I2C_CORE_TEMP)
    if( (msgs[0].flags == 0) && (msgs[0].addr == 0x2a) && (msgs[0].len == 8) )
	{
	  //i2c-20 && register 0 address
	  if(  (adap->name[0] == 105) && (adap->name[1] == 50)  && (adap->name[2] == 99) &&
           (adap->name[3] == 45)  && (adap->name[4] == 103) && (adap->name[5] == 112) &&
           (adap->name[6] == 105) && (adap->name[7] == 111) && (adap->name[8] == 50) && (adap->name[9] == 48) &&
	       (msgs[0].buf[0]== 0x0) && (msgs[0].buf[1]== 0x0) && (msgs[0].buf[2]== 0x0) && (msgs[0].buf[3]== 0x0) )
	  {
        vee_i2c_gpio_master_send(msgs[0].buf); 
	    return 8;
	  }
	}
	#endif
