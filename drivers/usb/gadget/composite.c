...
//  printk("WON>CONFIG>TYPE : %d \n", config_type);
	...
	list_for_each_entry(f, &config->functions, list) {
		...
		if (f->disabled || !descriptors || descriptors[0] == NULL)
			continue;
#ifdef CONFIG_USB_ANDROID_PTP	
//		printk("WON>CONFIG>NAME: %s > interfaceCount: %d\n", f->name, interfaceCount);
...
#if 0  // P50179 AT1 printRoid Test purpose		
	c->bNumInterfaces = num_interface;
#endif
