...
#ifdef FEATURE_PANTECH_MMP_QCOM_CR // CASE#00526246 during playing a "I09_HD720p10_1300x740x24_00.divx", green pixels are seen at the bottom lines
/*
From 6c9d0f8764af7a5a5653a8ad90b9f32fc9b6aa19 Mon Sep 17 00:00:00 2001
From: Ravishangar Kalyanam <rkalya@codeaurora.org>
Date: Mon, 18 Jul 2011 18:45:06 -0700
Subject: [PATCH] msm_fb: display: Adjust overlay VG pipe src params for non-zero x_offset 
...
CRs-Fixed: 296185
*/
void mdp4_overlay_vg_adjust_src_xoffset(struct mdp4_overlay_pipe *pipe,	char *vg_base)
{
...
#if 0 //20110819 KKS : This CR has a side effect. There happens a video frame jumping to vertical(x-axis) direction at landscape mode.
#ifdef FEATURE_PANTECH_MMP_QCOM_CR // CASE#00526246 during playing a "I09_HD720p10_1300x740x24_00.divx", green pixels are seen at the bottom lines
		...
		struct file **pp_src_file)
{
	...
	*pp_src_file = p_src_file;
	...
	if (pipe->mixer_num == MDP4_MIXER1) {
		...
		ctrl->mixer0_played++;
		if (ctrl->panel_mode & MDP4_PANEL_LCDC)
			mdp4_overlay_reg_flush(pipe, 1);  //hhs test 20110609 
