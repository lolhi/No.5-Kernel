...
#define FEATURE_ANDROID_PANTECH_USB_SERIAL_SET_at_8X60 //2011.06.15 <== 110713 jylee add from EF33
#define FEATURE_FASTER_USB_SERIAL_WRITE // 2011.07.25 jylee usb_serial_write sometimes works late in CTS 
...
#define FEATURE_AT1_PMIC_CHARGING
#define FEATURE_AT1_PMIC_RESET
#define FEATURE_AT1_FUELGAUGE_CUSTOM
#define FEATURE_AT1_PMIC_ADC
...
**  SENSORS
*******************************************************************************/
#define FEATURE_AT1_SENSOR //20110408 bandit add for AT1 Board Special Setting
