...
static struct workqueue_struct *suspend_sys_sync_work_queue; // Qualcomm 67024.patch
static DECLARE_COMPLETION(suspend_sys_sync_comp); // Qualcomm 67024.patch
...
err_suspend_sys_sync_work_queue: // Qualcomm 67024.patch
...
static void  __exit wakelocks_exit(void)
{
    ...
    destroy_workqueue(suspend_sys_sync_work_queue); // Qualcomm 67024.patch
	platform_driver_unregister(&power_driver);
	platform_device_unregister(&power_device);
	wake_lock_destroy(&unknown_wakeup);
	wake_lock_destroy(&main_wake_lock);
